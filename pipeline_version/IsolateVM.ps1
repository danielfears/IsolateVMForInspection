...
# Rest of your script using these parameters...
...
function Invoke-UserLoginFunction {
    param(
    ...
    Connect-AzAccount -ServicePrincipal -Tenant $AzureTenantId -Credential $Credential
}


# Validate user inputs

function Invoke-ValidateUserInputs {
    ...
    if ($subscriptionExists) {
        ...
        Write-Host "Subscription ID '$subscriptionId' is invalid."
        exit 1
    }
    ...
    if ($resourceGroupExists) {
        ...
        Write-Host "Resource group '$VMresourceGroupName' does not exist in the subscription."
        exit 1
    }
...
function Invoke-ValidateIPFormat {
...
function Invoke-CreateAssociateNSG {
